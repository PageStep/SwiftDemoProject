...
class EmoticonMatchTool: NSObject {
    // MARK:- 设计单例对象
    static let shareIntance : EmoticonMatchTool = EmoticonMatchTool()
    ...
    private func findPngPath(chs : String) -> String? {
        for package in manager.packages {
            for emoticon in package.emoticonItems {
                if emoticon.chs == chs {
